-- =========================================================
-- MEMÓRIAS QUE CONSTROEM DEMOCRACIA — FINAL v8
-- 1) administradores podem remover pontos publicados;
-- 2) cria Acervo Digital administrável;
-- 3) armazenamento separado para materiais do Acervo;
-- 4) políticas idempotentes.
-- Execute depois da estrutura/fix-v7.
-- =========================================================

create extension if not exists pgcrypto;

-- ---------------------------------------------------------
-- 1. REMOÇÃO DE PONTOS: somente admins autenticados.
-- ---------------------------------------------------------
...
grant delete on public.atlas_points to authenticated;
